...
namespace kmodular
{
    ...
    void Repeater::Reset()
    {
        ...
        delayEffectL->setTapDelayLevel(0, 0.4f);
        delayEffectR->setTapDelayLevel(0, 0.4f);
        ...
        delayEffectL->setTapDelayLevel(4, 0.4f);
        delayEffectR->setTapDelayLevel(4, 0.4f);
    ...
    {
		out[0] = delayEffectL->processSample(in[0]);
		out[1] = delayEffectR->processSample(in[1]);
    }
